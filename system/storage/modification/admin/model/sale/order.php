...
class ModelSaleOrder extends Model {
	...
	// public function get_myparcel_shipment($oid){
	// $query = $this->db->query("SELECT count(ship_id) as cnt FROM " . DB_PREFIX . "myparcel_shipment WHERE order_id = '" . (int)$oid . "'");
	// return $query->row;
	// }
...
public function myparcel_shipment_history($data){
		$this->db->query("INSERT IGNORE INTO " . DB_PREFIX . "myparcel_shipment_histroy SET order_id = '" . (int)$data['order_id'] . "', ship_id = '".$data['ship_id']."'");
		$sid = $this->db->getLastId();
		return $sid;
	}
	//CIS
